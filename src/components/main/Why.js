  ...
  return (
    <section className={styles['Why']}>
      ...
      <p className={styles.Burger}>
        Since most people hold their phone in their left hand, and use their right non-thumb fingers to scroll and top, a right side burger menu allows for clicking and scrolling without the right hand to cover up the screen. This allows the screen to remain more readable while interacting with the menu.
        <a 
